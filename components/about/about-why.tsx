...
const AboutWhyUs = () => {
    ...
    return ( 
        <div className="w-[100vw] bg-[#F5F5F5] flex flex-col justify-center items-center mt-[25px]">
            <h2 className="font-bold text-[3rem] p-4 mt-[50px]">Why Choose Cabinetry by Wettach??</h2>
            ...
            <div className="flex flex-wrap w-full h-full gap-4 p-4 justify-center items-center mb-[100px]">
                ...
                <CardComponent 
                    ...
                    content="With years of hands-on experience, our skilled craftspeople bring precision and pride to every cut, joint, and finish. Our cabinetry is handcrafted right here in Sarasota, Florida, with a focus on clean lines, smooth operation, and impeccable detail. "
                        />        
